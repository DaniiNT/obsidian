...
<body>
    ...
    <div class="container">
       ...
       <div class="btn btn-donate" style="">
            <a href="admin_panel.php" class="linkdonet">Kembali</a>
        </div>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                   ...
                   <a href="delete_donation.php?id=<?php echo $row['id']; ?>" class="btn btn-delete" onclick="return confirm('Apakah Anda yakin ingin menghapus donasi ini?')">Hapus</a>
                    <a href="admin_panel.php?verify=1&id=<?php echo $row['id']; ?>" class="btn btn-verif">Verifikasi</a>
                    <a href="admin_panel.php?reject=1&id=<?php echo $row['id']; ?>" class="btn btn-tolak">Tolak</a>
                </td>
        ...
        <?php if ($page > 1): ?>
                <a href="detail_donasi_admin.php?id=<?= $_GET['id']?>&page=<?php echo $page - 1; ?>">&laquo; Prev</a>
            <?php endif; ?>

            <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                <a href="detail_donasi_admin.php?id=<?= $_GET['id']?>&page=<?php echo $i; ?>" class="<?php if ($i == $page) echo 'active'; ?>"><?php echo $i; ?></a>
            <?php endfor; ?>

            <?php if ($page < $total_pages): ?>
                <a href="detail_donasi_admin.php?id=<?= $_GET['id']?>&page=<?php echo $page + 1; ?>">Next &raquo;</a>
            <?php endif; ?>
        </div>
    </div>
    <div class="menu">
